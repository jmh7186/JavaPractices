		...
		<form action="update.jsp">
			...
			<div class="mb-3 mt-3">
				<label for="name">이름:</label> <input type="text"
					class="form-control" id="name" name="name" readonly value="<%=name%>">
			</div>
			<div class="mb-3 mt-3">
				<label for="전화번호">전화번호:</label> <input type="text"
					class="form-control" id="hp" name="hp" readonly value="<%=hp%>">
			</div>
			<div class="mb-3 mt-3">
				<label for="전화번호">직장:</label> <input type="text"
					class="form-control" id="company" name="company" readonly value="<%=company%>">
			</div>
			<div class="mb-3 mt-3">
				<label for="전화번호">이메일:</label> <input type="text"
					class="form-control" id="email" name="email" readonly value="<%=email%>">
			</div>
			<div class="mb-3 mt-3">
				<label for="전화번호">주소:</label> <input type="text"
					class="form-control" id="address" name="address" readonly value="<%=address%>">
			</div>
			<div class="mb-3 mt-3">
				<label for="전화번호">생일:</label> <input type="text"
					class="form-control" id="birthday" name="birthday" readonly value="<%=birthday%>">
			</div>
			<div class="mb-3 mt-3">
				<label for="memo">메모:</label> <input type="text"
					class="form-control" id="memo" name="memo" readonly value="<%=memo%>">
			</div>

			<button type="submit" class="btn btn-primary" onclick="location.href='update.jsp?idx=<%=idx%>'">수정</button>
			<button type="button" class="btn btn-danger" onclick="location.href='delete.jsp?idx=<%=idx%>'">삭제</button>
		</form>
	</div>
